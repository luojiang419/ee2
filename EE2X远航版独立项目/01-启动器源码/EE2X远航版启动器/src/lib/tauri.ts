...
const STORAGE_CONFIG = "ee2x.yuanhang.mock.config";
const STORAGE_USER = "ee2x.yuanhang.mock.user";
const STORAGE_RELEASE = "ee2x.yuanhang.mock.release";
const STORAGE_NETWORK = "ee2x.yuanhang.mock.network";
const STORAGE_AUTOSTART = "ee2x.yuanhang.mock.autostart";
...
const defaultConfig: AppConfig = {
  ...
  updateServerHttp: "http://115.231.35.105:3014",
  updateServerWs: "ws://115.231.35.105:3014/api/update/v1/channels/stable/ws",
