...
const APP_DATA_DIR_OVERRIDE_ENV: &str = "EE2X_YH_LAUNCHER_APPDATA_DIR_OVERRIDE";
const INSTALL_DIR_OVERRIDE_ENV: &str = "EE2X_YH_LAUNCHER_INSTALL_DIR_OVERRIDE";
const MATCHMAKING_URL: &str = "http://115.231.35.105:4002/matchmaking";
const DEFAULT_USER_SERVER: &str = "http://115.231.35.105:3001";
const DEFAULT_UPDATE_SERVER: &str = "http://115.231.35.105:3014";
const DEFAULT_UPDATE_WS: &str = "ws://115.231.35.105:3014/api/update/v1/channels/stable/ws";
