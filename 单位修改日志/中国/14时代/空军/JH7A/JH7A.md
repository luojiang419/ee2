...
| 属性 | 值 | 来源文件 |
|:-----|:---|:--------|
| areaDamageRadius | 3.0 | Chinese_army.ddf:1026 |

### 修改后数据
| 属性 | 值 | 来源文件 |
|:-----|:---|:--------|
| areaDamageRadius | 1.3 | Chinese_army.ddf:1026 |

### 关联文件
- `EE2X_db/Units/Chinese_army.ddf:1026` — JH7A14Attack

### 修改依据
- 需求: JH7A/A10/su25三机对地攻击溅射统一调整为1.3
- 理由: JH7A原溅射3.0过大(A10/su25仅1.5)，统一为1.3保持对地攻击机溅射身份但不过于夸张

### 已知影响
- 溅射面积从28.3降至5.3，对密集地面单位压制力大幅下降
- 与A10/su25溅射一致，三国对地攻击机溅射统一
