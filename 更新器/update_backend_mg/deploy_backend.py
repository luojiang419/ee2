...
def main() -> None:
    ...
    parser.add_argument("--backup-root", default="/root/ee2x/backups")
    ...
    try:
        ...
        staging_root = posixpath.join(remote_parent, "update_backend_mg")
        ...
        should_import_legacy = not (has_existing_db or has_existing_storage)
        ...
        print(f"IMPORTED_LEGACY={'1' if should_import_legacy else '0'}")
    finally:
        client.close()
